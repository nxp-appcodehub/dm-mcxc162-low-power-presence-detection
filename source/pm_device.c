...
//__attribute__((used, aligned(4), section(".g_resc_ctrl_table")))
const resc_status_t g_resc_ctrl_table[kResc_Max_Num][APP_LOW_POWER_MODE_COUNT] = {
    /*! Clock modules. */
    [kResc_Fro_144M]            = {kResc_Status_On,     },
    [kResc_Fro_12M]             = {kResc_Status_Off,    },
    [kResc_Osc_32K]             = {kResc_Status_Off,    },
    [kResc_Fro_16K]             = {kResc_Status_On,     },

    /*! Power domain modules */
    [kResc_LdoCore]             = {kResc_Status_On,     },
    [kResc_RamRetentionLdo]     = {kResc_Status_On,     },
    [kResc_Core_Vdd_Lvd_Act]    = {kResc_Status_Off,    },
    [kResc_Sys_Vdd_Lvd_Act]     = {kResc_Status_Off,    },
    [kResc_Sys_Vdd_Hvd_Act]     = {kResc_Status_Off,    },
    [kResc_Core_Vdd_Lvd_Lp]     = {kResc_Status_Off,    },
    [kResc_Sys_Vdd_Lvd_Lp]      = {kResc_Status_Off,    },
    [kResc_Sys_Vdd_Hvd_Lp]      = {kResc_Status_Off,    },
    [kResc_GlitchDetector_Act]  = {kResc_Status_Off,    },
    [kResc_GlitchDetector_Lp]   = {kResc_Status_Off,    },

    /*! SRAM modules */
    [kResc_RamA]                = {kResc_Status_On,     },

    /*! Analog modules */
    [kResc_Opamp0]              = {kResc_Status_Off,    },
    [kResc_Cmp0]                = {kResc_Status_Off,    },
    [kResc_Cmp0_Dac]            = {kResc_Status_Off,    },
};
...
static void ApplyRescTableForMode(uint8_t modeIndex)
{
    ...
    {
        resc_status_t status = g_resc_ctrl_table[(uint32_t)resc][(uint32_t)0];
