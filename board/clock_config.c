...
- {id: LPSPI0_clock.outFreq, value: 12 MHz}
...
- {id: MRCC.LPI2C0_CLKSEL.sel, value: SYSCON.FRO_12M_DIV_clock}
- {id: MRCC.LPSPI0_CLKSEL.sel, value: SYSCON.FRO_12M_DIV_clock}
sources:
...
void BOARD_BootClockFROHF72M_InitClockModule(clock_module_t module)
{
    ...
    switch(module) {
        ...
        case kClockModule_LPI2C0Clk:
            CLOCK_AttachClk(kFRO_LF_DIV_to_LPI2C0);        /* !< Switch LPI2C0 to FRO_LF_DIV */
            CLOCK_SetClockDiv(kCLOCK_DivLPI2C0, 1U);       /* !< Set MRCC.LPI2C0_CLKDIV divider to value 1 */
            break;
        case kClockModule_LPSPI0Clk:
            CLOCK_AttachClk(kFRO_LF_DIV_to_LPSPI0);        /* !< Switch LPSPI0 to FRO_LF_DIV */
            CLOCK_SetClockDiv(kCLOCK_DivLPSPI0, 1U);       /* !< Set MRCC.LPSPI0_CLKDIV divider to value 1 */
            break;
